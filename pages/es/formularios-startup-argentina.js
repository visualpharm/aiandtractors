      ...
      <div className="forms-page">
        <div className="container">
          ...
          <div className="disclaimer">
            <p><strong>⚠️ Importante:</strong> Todos los modelos son plantillas de referencia y <strong>no sustituyen asesoría legal profesional</strong>.</p>
          </div>
          ...
          <div className="tip-box">
            <p><strong>💡 Tip rápido:</strong> Si recién empezás, podés funcionar como <strong>sociedad de hecho Argentina</strong> con responsabilidad ilimitada; este paquete de contratos te blinda mientras reunís el cash-flow necesario para constituir tu SAS.</p>
          </div>
          ...
          <section className="cta-section">
            ...
            <div className="cta-buttons">
              <Link href="/es/contact" className="cta-button primary">
                Contactar para Asesoría
              </Link>
              <Link href="/forms" className="cta-button secondary">
          ...
          <section className="keywords-section">
            <h3>🔍 Keywords objetivo (integradas)</h3>
