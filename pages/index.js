...
const translations = {
  en: {
    ...
    description: "Founded and bootstrapped Icons8 and Generated Photos, serving 4M+ users with creative tools and AI-powered features. Built remote team of 150 people. Pioneer in AI implementation for design and creative industries. International speaker on AI transformation and bootstrapped growth.",
  ...
  es: {
    ...
    description: "Fundó y bootstrapped Icons8 y Generated Photos, sirviendo a más de 4M usuarios con herramientas creativas y funciones impulsadas por IA. Construyó equipo remoto de 150 personas. Pionero en implementación de IA para industrias de diseño y creativas. Speaker internacional sobre transformación IA y crecimiento bootstrapped.",
  ...
  pt: {
    ...
    description: "Fundou e fez bootstrapped de Icons8 e Generated Photos, servindo mais de 4M usuários com ferramentas criativas e recursos alimentados por IA. Construiu equipe remota de 150 pessoas. Pioneiro na implementação de IA para indústrias de design e criativas. Palestrante internacional sobre transformação IA e crescimento bootstrapped.",
...
export default function Home() {
  ...
  const descriptionWithLinks = language === 'en' ? (
    <>
      Founded and bootstrapped <a href="https://icons8.com" className="text-blue-600 no-underline hover:text-gray-900">Icons8</a> and <a href="https://generated.photos" className="text-blue-600 no-underline hover:text-gray-900">Generated Photos</a>, serving 4M+ users with creative tools and AI-powered features. Built remote team of 150 people. Pioneer in AI implementation for design and creative industries. International speaker on AI transformation and bootstrapped growth.
    </>
  ) : language === 'es' ? (
    <>
