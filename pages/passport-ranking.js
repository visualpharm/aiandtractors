...
const passportData = [
  ...
  { id: 'singapore', country: 'Singapore', flag: '🇸🇬', score: 1206, homeBonus: 14, keyAccess: ['Schengen', 'China', 'USA', 'India', 'Indonesia'], topContributors: [{ country: 'Schengen', value: 400 }, { country: 'USA', value: 67 }, { country: 'China', value: 35 }, { country: 'India', value: 18 }, { country: 'Indonesia', value: 16 }], misses: [{ country: 'Russia', value: -25 }, { country: 'North Korea', value: -0.01 }], note: { title: 'Neutral Ground Pays Off', text: 'Singapore hosts summits between hostile nations. This diplomatic positioning earned visa-free access from both China and India - a combination almost no Western passport can match. But no Russia access.' } },
