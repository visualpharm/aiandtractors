...
const translations = {
  en: {
    ...
    description: "Founded and bootstrapped Icons8 and Generated Photos, serving 4M+ users with creative tools and AI-powered features. Built remote team of 150 full-time contractors. International speaker on AI transformation and bootstrapped growth.",
...
export default function Home() {
  ...
  const descriptionWithLinks = language === 'en' ? (
    <>
      Founded and bootstrapped <a href="https://icons8.com" className="text-blue-600 no-underline hover:text-gray-900">Icons8</a> and <a href="https://generated.photos" className="text-blue-600 no-underline hover:text-gray-900">Generated Photos</a>, serving 4M+ users with creative tools and AI-powered features. Built remote team of 150 full-time contractors. International speaker on AI transformation and bootstrapped growth.
    </>
  ) : language === 'es' ? (
    <>
