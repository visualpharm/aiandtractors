      ...
      <section className="bg-gray-50 py-8 md:py-16 flex items-center justify-center">
        <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="text-left">
            <h1 className="text-6xl md:text-7xl font-normal text-gray-900 mb-8 -ml-2 leading-tight" style={{ fontFamily: "'DotGothic16', monospace" }}>
              {title}
            </h1>
          ...
          <div className="flex justify-center items-center">
            <a href={imageUrl || "/i/ivan-robot.png"} data-fancybox="profile">
              <Image 
                ...
                className="w-full max-w-[576px] sm:max-w-[612px] md:max-w-[727px] h-auto object-contain drop-shadow-lg transition-transform duration-300 hover:scale-105"
                priority
              />
            </a>
          </div>
